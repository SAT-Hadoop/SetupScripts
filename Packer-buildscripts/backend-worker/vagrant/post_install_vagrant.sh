...
wget --directory-prefix=/tmp https://raw.githubusercontent.com/SAT-Hadoop/SetupScripts/master/setup-hadoop.sh 
chmod 777 /tmp/setup-hadoop.sh
/tmp/setup-hadoop.sh

git clone https://github.com/SAT-Hadoop/BackendWorker.git ~/BackendWorker
